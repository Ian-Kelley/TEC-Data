...
def main():
    ...
    st.write('Currently a work in progress. Only day available is 10/20/2017')
    ...
    if function == 'Interactive Plotter':
        ...
        showmovie(date)
        st.write('Animation resolution has been reduced for display purposes.  Contact Ian Kelley for a higher resolution Version.')
